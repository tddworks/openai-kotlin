...
data class ImageCreate(
    ...
    @SerialName("model") val model: OpenAIModel = OpenAIModel.DALL_E_2,
    ...
    /**
     * The quality of the image that will be generated. `Quality.HD` creates images with finer
    ...
    companion object {
         ...
         */
        fun create(prompt: String, model: OpenAIModel = OpenAIModel.DALL_E_3): ImageCreate =
            ImageCreate(prompt = prompt, model = model)
         ...
         * @param style The style of the generated images. Must be one of vivid or natural. Vivid
         ...
         * @param quality The quality of the image that will be generated. `Quality.HD` creates
         *   images with finer details and greater consistency across the image. This param is only
         *   supported for `dall-e-3`.
         * @param format The format in which the generated images are returned. Must be one of url
         *   or b64_json.
         */
        fun create(
            prompt: String,

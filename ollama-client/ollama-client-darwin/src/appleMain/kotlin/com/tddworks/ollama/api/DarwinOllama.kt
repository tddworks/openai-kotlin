 ...
 *
 * @param port a function that returns the port number for the Ollama instance, defaults to
 *   Ollama.PORT
 * @param protocol a function that returns the protocol for the Ollama instance, defaults to
 *   Ollama.PROTOCOL
 * @param baseUrl a function that returns the base URL for the Ollama instance, defaults to
 *   Ollama.BASE_URL
...
object DarwinOllama {
     ...
     * @param protocol function returning a string representing the protocol, defaults to
     *   Ollama.PROTOCOL
     * @param baseUrl function returning a string representing the base URL, defaults to
     *   Ollama.BASE_URL
     * @return an Ollama instance created with the provided configuration
     */
    fun ollama(baseUrl: () -> String = { Ollama.BASE_URL }): Ollama =

...
class AnthropicITest : AutoCloseKoinTest() {
    ...
    fun `should return create response`() = runTest {
        // Client request(POST https://api.anthropic.com/v1/messages) invalid: 401 Unauthorized.
        // Text: "{"type":"error","error":{"type":"authentication_error","message":"invalid
        // x-api-key"}}"
        // Client request(POST https://api.anthropic.com/v1/messages) invalid: 400 Bad Request.
        // Text:
        // "{"type":"error","error":{"type":"invalid_request_error","message":"anthropic-version:
        // header is required"}}"
        val r =
            anthropic.create(
                CreateMessageRequest(
